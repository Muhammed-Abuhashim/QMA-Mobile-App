...
import 'package:main/screans/radio.dart';
...
class patient_sign_up extends StatefulWidget {
  patient_sign_up({ Key? key }) : super(key: key);

  static String id='patient_sign_up';
  get decoration => null;
...
class _patient_sign_upState extends State<patient_sign_up> {
 ...
 // string for displaying the error Message
  ...
  final wheelchairIdEditingController = new TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    final nationalIdField = TextFormField(
        ...
        decoration: InputDecoration(
         ...
         //wheelchairId field
    final wheelchairIdField = TextFormField(
        autofocus: false,
        controller: wheelchairIdEditingController,
        keyboardType: TextInputType.name,
        validator: (value) {
          if (value!.isEmpty) {
            return ("Wheelchair ID cannot be Empty");
          }
          return null;
        },
        onSaved: (value) {
          wheelchairIdEditingController.text = value!;
        },
        textInputAction: TextInputAction.next,
        decoration: InputDecoration(
          fillColor: Color.fromARGB(151, 224, 203, 189),
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                            ...
                            Container(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text('DOES HE SUFFER FROM \n\t\t\t\t\t\t\t\t\t\t\t\t\tDiabetes ?',
                      ...
                      SizedBox(height: 20),
                      Container( 
                        margin: const EdgeInsets.fromLTRB(37, 0, 0, 25),
                        child: Row(
                          children: <Widget>[
  ...
  postDetailsToFirestore() async {
    ...
    userModel.wheelchairId = wheelchairIdEditingController.text;
