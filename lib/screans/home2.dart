...
import 'package:main/screans/profile_patient.dart';
            ...
            children: [
              ...
              Container(
                ...
                child: ListTile(
                  ...
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => profile_patient()));
                  },
                ),
              ),
              ...
              Container(
                ...
                child: ListTile(
                  leading: Icon(Icons.arrow_forward_ios,size: _drawerIconSize,color: _drawercolor),
                  title: Text('MEDICAL HISTORY', style: TextStyle(fontFamily: "El Messiri", fontWeight: FontWeight.w700,fontSize: _drawerFontSize, color: _drawercolor),
                  ),
                  onTap: () {
              ...
              Container(
                ...
                child: ListTile(
                  leading: Icon(Icons.arrow_forward_ios, size: _drawerIconSize,color: _drawercolor),
                  title: Text('MY CONTACT',style: TextStyle(fontFamily: "El Messiri", fontWeight: FontWeight.w700,fontSize: _drawerFontSize,color:  _drawercolor),),
                  onTap: () {
