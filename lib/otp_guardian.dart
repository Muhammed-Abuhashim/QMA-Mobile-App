...
import 'package:main/screans/home2_guardian.dart';
import 'package:pin_code_fields/pin_code_fields.dart';


class otp_guardian extends StatefulWidget {
  static String id='otp_guardian';
  const otp_guardian({Key? key}) : super(key: key);

  @override
  State<otp_guardian> createState() => _otp_guardianState();
}

class _otp_guardianState extends State<otp_guardian> {
  ...
  Future<void> verifyOTP() async {
    await FirebaseAuth.instance.signInWithCredential(
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (context) => home2_guardian(),
        ),
      );
    });
  }
